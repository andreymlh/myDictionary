...
namespace MyDictionary.Core.Data
{
    ...
    public class CategoryDataSource
    {
        ...
        /// </summary>
        private readonly string path = ".\\category_data.json";
        ...
        public List<Category> Get()
        {
            if (File.Exists(path))
            {
                ...
                var tmp = DataSerializer.Deserialize<List<Category>>(data) ?? new List<Category>();
                Category._id_counter = tmp.Count > 0 ? tmp.Select(x => x.ItemId).Max() + 1 : 0;
                return tmp;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public void Write(List<Category> data)
        {
